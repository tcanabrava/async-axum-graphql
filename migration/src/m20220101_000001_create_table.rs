...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    .table(RecipeStepMediaPicture::Table)
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .from(
                                RecipeStepMediaPicture::Table,
                                RecipeStepMediaPicture::MediaId,
                            )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .from(
                                RecipeStepMediaPicture::Table,
                                RecipeStepMediaPicture::RecipeStepId,
                            )
        ...
        manager
            .create_table(
                Table::create()
                    .table(RecipeStepMediaVideo::Table)
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .from(
                                RecipeStepMediaVideo::Table,
                                RecipeStepMediaVideo::RecipeStepId,
                            )
                            .to(RecipeStep::Table, RecipeStep::Id),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    .table(IngredientMediaVideo::Table)
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .from(
                                IngredientMediaVideo::Table,
                                IngredientMediaVideo::IngredientId,
                            )
        ...
        manager
            .create_table(
                Table::create()
                    .table(IngredientMediaPicture::Table)
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .from(
                                IngredientMediaPicture::Table,
                                IngredientMediaPicture::MediaId,
                            )
                            .to(MediaPicture::Table, MediaPicture::Id),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .from(
                                IngredientMediaPicture::Table,
                                IngredientMediaPicture::IngredientId,
                            )
                            .to(Ingredient::Table, Ingredient::Id),
                    )
                    .to_owned(),
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(IngredientMediaVideo::Table).to_owned())
            .await?;
        manager
            .drop_table(
                Table::drop()
            ...
            .await?;
        manager
            .drop_table(Table::drop().table(RecipeMember::Table).to_owned())
            .await?;
        manager
        ...
        manager
            ...
            .await?;
        manager
            .drop_table(Table::drop().table(RecipeStepMediaVideo::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(MediaVideo::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(MediaPicture::Table).to_owned())
            .await?;
        manager
